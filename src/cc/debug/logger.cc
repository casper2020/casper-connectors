 ...
 */
cc::debug::OneShot::OneShot (cc::debug::Logger& a_instance)
    : ::cc::Initializer<::cc::debug::Logger>(a_instance)
{
...
* @param a_token
*/
void cc::debug::Logger::Register (const std::string& a_token)
{
  ...
  // ... keep track of it ...
  tokens_[a_token] = new Token(a_token, "stdout", stdout);
}
 ...
 * @param ...
 */
void cc::debug::Logger::Log (const char* const a_token, const char* a_format, ...)
{
    std::lock_guard<std::mutex> lock(mutex_);

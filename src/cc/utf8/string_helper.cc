 ...
 */
bool cc::utf8::StringHelper::StartsWith (const std::string& a_first, const std::string& a_second)
{
    cc::utf8::StringViewer first_string  = cc::utf8::StringViewer(a_first);
    cc::utf8::StringViewer second_string = cc::utf8::StringViewer(a_second);
    ...
    do {
        ...
        // lower case
        if ( c1 < sizeof(cc::utf8::CollationTables::k_utf8_collation_table_lower_)/sizeof(uint16_t) ) {
            c1 = cc::utf8::CollationTables::k_utf8_collation_table_lower_[c1];
        }

        uint16_t c2 = second_string.Next();
        if ( c2 < sizeof(cc::utf8::CollationTables::k_utf8_collation_table_lower_)/sizeof(uint16_t) ) {
            c2 = cc::utf8::CollationTables::k_utf8_collation_table_lower_[c2];
        }
        ...
        if ( c2 == 0 ) {
            ...
            // normalized
            c1 = cc::utf8::CollationTables::k_utf8_collation_table_[c1];
            c2 = cc::utf8::CollationTables::k_utf8_collation_table_[c2];
            if ( c1 != c2 ) {
                return false;
            }
        }
 ...
 */
bool cc::utf8::StringHelper::Contains (const std::string& a_first, const std::string& a_second)
{
 ...
 */
bool cc::utf8::StringHelper::FilterOut (const std::string& a_string, const std::string& a_filter, std::vector<std::string>* o_words)
{
    ...
    if ( filter_words.size() <= text_words.size() ) {
        for ( auto text_words_iterator = text_words.begin(); text_words_iterator != text_words.end(); ++text_words_iterator ) {
            for ( auto filter_words_iterator = filter_words.begin(); filter_words_iterator != filter_words.end(); ++filter_words_iterator ) {
                if ( true == cc::utf8::StringHelper::StartsWith((*text_words_iterator), (*filter_words_iterator)) ) {
                    if ( nullptr != o_words ) {
 ...
 * @param o_words  String words.
 */
void cc::utf8::StringHelper::SplitWords (const std::string& a_string, std::vector<std::string>& o_words)
{
    o_words.clear();
 ...
 */
void cc::utf8::StringHelper::Replace (const std::string& a_string, const std::string& a_from, const std::string& a_to, std::string& o_string)
{
    size_t pos = 0;
 ...
 * @return
 */
std::string cc::utf8::StringHelper::ReplaceAll (const std::string& a_source, const std::string& a_search, const std::string& a_replace)
{
 ...
 */
std::string& cc::utf8::StringHelper::Trim (std::string& a_string)
{
 ...
 */
std::string cc::utf8::StringHelper::Collate (const char* const a_string)
{
    cc::utf8::StringViewer iterator = cc::utf8::StringViewer(a_string);
    ...
    do {
        ...
        if ( utf_16_char < sizeof(cc::utf8::CollationTables::k_utf8_collation_table_)/sizeof(uint16_t) ) {
            utf_16_char = cc::utf8::CollationTables::k_utf8_collation_table_[utf_16_char];
        }
 ...
 * @return The final result, with the white spaces removed from left and right.
 */
std::string cc::utf8::StringHelper::Trim (const char* const a_string)
{
    std::string str = a_string;
    return cc::utf8::StringHelper::Trim(str);
}
 ...
 */
void cc::utf8::StringHelper::URIEncode (const std::string& a_string, std::string& o_string)
{
 ...
 */
std::string cc::utf8::StringHelper::URIEncode (const std::string& a_uri)
{
    // ... if uri is empty ...
    if ( 0 == a_uri.length() ) {
        // ... no URI to encode  ...
 ...
 */
void cc::utf8::StringHelper::URIDecode (const std::string & a_string, std::string& o_string)
{
    //
    // RFC1630:
    //
 ...
 */
std::tuple<size_t, size_t> cc::utf8::StringHelper::CountForJson (const std::string& a_string)
{
 ...
 */
void cc::utf8::StringHelper::JSONEncode (const std::string& a_string, uint8_t* o_out)
{
    cc::utf8::StringViewer it = cc::utf8::StringViewer(a_string);
    uint16_t utf_16_char;
 ...
 * @return
 */
std::string cc::utf8::StringHelper::JSONEncode (const std::string& a_string)
{
    uint8_t* out = new uint8_t[( a_string.length() * 2 ) + 1];
    cc::utf8::StringHelper::JSONEncode(a_string, out);

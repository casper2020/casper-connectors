                                     ...
                                     std::string* o_query)
{
     ...
     */
    std::stringstream ss;
    ss << "SELECT response,http_status FROM jsonapi('GET', '" << a_uri << "', '', '" << user_id_ << "', '" << entity_id_ << "', '" << entity_schema_ << "', '" << sharded_schema_ << "', '" << accounting_schema_ << "', '" << accounting_prefix_ << "');";
                                      ...
                                      std::string* o_query)
{
     ...
     */
    std::stringstream ss;
    ss << "SELECT response,http_status FROM jsonapi('POST','" << a_uri << "','" << a_body <<  "','" << user_id_ << "', '" << entity_id_ << "', '" << entity_schema_ << "', '" << sharded_schema_ << "', '" << accounting_schema_ << "', '" << accounting_prefix_ << "');";
                                       ...
                                       std::string* o_query)
{
     ...
     */
    std::stringstream ss;
    ss << "SELECT response,http_status FROM jsonapi('PATCH','" << a_uri << "','" << a_body <<  "','" << user_id_ << "', '" << entity_id_ << "', '" << entity_schema_ << "', '" << sharded_schema_ << "', '" << accounting_schema_ << "', '" << accounting_prefix_ << "');";
                                        ...
                                        std::string* o_query)
{
     ...
     */
    std::stringstream ss;
    ss << "SELECT response,http_status FROM jsonapi('DELETE','" << a_uri << "','" << a_body <<  "','" << user_id_ << "', '" << entity_id_ << "', '" << entity_schema_ << "', '" << sharded_schema_ << "', '" << accounting_schema_ << "', '" << accounting_prefix_ << "');";

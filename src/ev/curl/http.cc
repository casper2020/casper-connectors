...
{
    Async(new ::ev::curl::Request(a_loggable_data,
                                  curl::Request::HTTPRequestType::PUT, a_url, a_headers, a_body, /* a_disable_chunked */ true
          ),
          a_success_callback, a_failure_callback
    );
}
...
{
    Async(new ::ev::curl::Request(a_loggable_data,
                                  curl::Request::HTTPRequestType::POST, a_url, a_headers, a_body, /* a_disable_chunked */ true
          ),
          a_success_callback, a_failure_callback
    );
}
